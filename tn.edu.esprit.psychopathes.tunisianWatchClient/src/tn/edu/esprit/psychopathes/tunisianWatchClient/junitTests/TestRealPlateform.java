...
public class TestRealPlateform {
	...
	private CitizenServicesRemote citizenServicesRemote;
	...
	public void test() {
		try {
			...
			citizenServicesRemote = (CitizenServicesRemote) context
					.lookup("ejb:tn.edu.esprit.psychopathes.tunisianWatch/tn.edu.esprit.psychopathes.tunisianWatchEJB/CitizenServices!tn.edu.esprit.gl8.tunisianWatch.impl.CitizenServicesRemote");
	...
	public void itShouldAssaignClaimToAuth() {
		...
		citizen.setNomCitizen("chdouluch");
		citizen.setPrenomCitizen("hafaiedh");
		citizen.setLoginCitizen("admin");
		citizen.setPwdCitizen("qwerty");
		citizen.setAdressCitizen("aouina");
		citizen.setAgeCitizen(7);
		citizen.assignClaimToToThisCitizen(claims);

		Assert.assertTrue(authorityServicesRemote.insertAuthority(authority));
		Assert.assertTrue(citizenServicesRemote.insertCitizen(citizen));
